...
def model():
    ...
    songbyte = minioClient.fget_object(queueBucketName, "Data.csv",f"./inputs/Data.csv")
    games = pd.read_csv("./inputs/Data.csv")
    games.columns = games.iloc[0]
    # games.rename(columns = games.iloc[1].tolist(), inplace = True)
    games = games.iloc[1:]
