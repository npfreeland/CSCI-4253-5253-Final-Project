...
# # playerstats = playercareerstats.PlayerCareerStats(data=get_data_sets()SeasonTotalsRegularSeason'])
# data_sets = nba_response.get_data_sets()

# print(playerstats.get_data_frames()[0])
...
class PlayerCareerStats(Endpoint):
    ...
    def load_response(self):
        ...
        print(self.season_totals_regular_season.head(5))
PlayerCareerStats(Endpoint)